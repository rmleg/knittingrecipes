            ...
            <div id="recipe" className="pt-5 mt-5 border-top">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8">
                        <h3>Brim</h3>
                        <p>Using the long tail or your favorite stretchy cast on, CO {this.state.fullStCount} sts. 
                         Join to work in the round, being careful not to twist.</p>
                         <p>Rnd 1: *k2, p2; rep from * to end. Work rnd 1 until work measures 2 inches from CO edge,
                        ...
                        { this.state.height < 8 ? 
                            <p>Rnd 1: *k6, k2tog; rep from * to end.<br />
                                Rnd 2: k all sts.<br />
                                Rnd 3: *k5, k2tog; rep from * to end.<br />
                                Rnd 4: k all sts.<br />
                                Rnd 5: *k4, k2tog; rep from * to end.<br />
                                Rnd 6: k all sts.<br />
                                Rnd 7: *k3, k2tog; rep from * to end.<br />
                                Rnd 8: *k2, k2tog; rep from * to end.<br />
                                Rnd 9: *k1, k2tog; rep from * to end.<br />
                                Rnd 10: *k2tog; rep from * to end.</p> 
                            :
                            <p>Rnd 1: *k6, k2tog; rep from * to end.<br />
                                Rnd 2: k all sts.<br />
                                Rnd 3: k all sts.<br />
                                Rnd 4: *k5, k2tog; rep from * to end.<br />
                                Rnd 5: k all sts.<br />
                                Rnd 6: k all sts.<br />
                                Rnd 7: *k4, k2tog; rep from * to end.<br />
                                Rnd 8: k all sts.<br />
                                Rnd 9: k all sts.<br />
                                Rnd 10: *k3, k2tog; rep from * to end.<br />
                                Rnd 11: k all sts.<br />
                                Rnd 12: *k2, k2tog; rep from * to end.<br />
                                Rnd 13: k all sts.<br />
                                Rnd 14: *k1, k2tog; rep from * to end.<br />
                                Rnd 15: k all sts.<br />
                                Rnd 16: *k2tog; rep from * to end.</p>
                        }
                        <p>If more than 8 sts remain, work Rnd 16 until 8 sts remain.</p>
                        <h3>Finishing</h3>
                        <p>Cut yarn, leaving a 6-inch tail. Draw tail through remaining sts and secure.
                             Weave in ends, block, and enjoy!</p>
                    </div>
                </div>
            </div>
        );
