...
function CuffDownToe({ fullStCount }: { fullStCount: number }) {
  return (
    <div>
      <h3>Toe</h3>
      <p>
      ...
      <p>
        Rep rnds 1 and 2 until you have {fullStCount / 2} sts remaining. Then,
        rep rnd 1 twice more.
      </p>
      <p>
        At the end of your decreases, you should have {fullStCount / 2 - 8} sts
        remaining, {getMultiple((fullStCount / 2 - 8) / 2, 2)} on the instep and{" "}
        {getMultiple((fullStCount / 2 - 8) / 2, 2)} on the sole.
      </p>
      <p>
