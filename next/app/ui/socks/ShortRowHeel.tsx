import { getMultiple } from "@/app/utils/utils";

function ShortRowHeel({ fullStCount }: { fullStCount: number }) {
  return (
    <div id="shortRowHeel">
      <h3>Heel</h3>
      <p>
        The short row heel is worked flat over the next {fullStCount / 2} sts,
        which are half your total sts. References to the first and last sts in
        these instructions refer to the first of this half and the last of this
        half of your sts, i.e. the heel sts.
      </p>
      ...
      <p>
        Rep rows 3 and 4 until {getMultiple(fullStCount / 6, 2)} sts are left
